...
export class InvoiceUploadComponent implements OnInit {
    ...
    async loadPOItems() {
        ...
        let itemsList: ItemModel[] = (this._poItemsResultDetails && this._poItemsResultDetails.itemsList) ? this._poItemsResultDetails.itemsList.concat():null;
        ...
        this.noVendorPO = (this._poItemsResultDetails && this._poItemsResultDetails.statusDetails && this._poItemsResultDetails.statusDetails.isSuccess == false) ? true : false;
